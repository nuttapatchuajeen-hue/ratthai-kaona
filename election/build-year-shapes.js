...
const AMP_ALIAS_RAW = {
  ...
  /* กทม. ตั้ง 11 เขตใหม่พร้อมกันเมื่อ 21 พ.ย. 2540 (ราชกิจจาฯ เล่ม 114 ตอนพิเศษ 108 ง)
     ก่อนหน้านั้นยังเป็น 38 เขต การเลือกตั้ง 2539 จึงต้องยุบกลับไปที่เขตแม่
     ⚠ คันนายาว = แขวงคันนายาว+คลองกุ่มบางส่วน (บึงกุ่ม) + จรเข้บัวบางส่วน (ลาดพร้าว)
       สะพานสูง = แขวงสะพานสูง (บึงกุ่ม) + หมู่ 7-12 แขวงประเวศ (ประเวศ)
       ทั้งคู่มาจากบึงกุ่มเป็นส่วนใหญ่ จึงยกไปรวมกับบึงกุ่ม (เขตเลือกตั้งที่ 7)
       ส่วนที่มาจากลาดพร้าว/ประเวศ แยกออกจากรูปร่างไม่ได้ จะถูกลงสีเป็นเขต 7 ไปด้วย */
  "กรุงเทพมหานคร": [{ before: 2540, map: {
    "บางเขน":      ["บางเขน", "สายไหม"],
    "ดอนเมือง":    ["ดอนเมือง", "หลักสี่"],
    "บึงกุ่ม":     ["บึงกุ่ม", "คันนายาว", "สะพานสูง"],
    "บางกะปิ":     ["บางกะปิ", "วังทองหลาง"],
    "คลองเตย":     ["คลองเตย", "วัฒนา"],
    "พระโขนง":     ["พระโขนง", "บางนา"],
    "มีนบุรี":     ["มีนบุรี", "คลองสามวา"],
    "ภาษีเจริญ":   ["ภาษีเจริญ", "บางแค"],
    "ตลิ่งชัน":    ["ตลิ่งชัน", "ทวีวัฒนา"],
    "บางขุนเทียน": ["บางขุนเทียน", "บางบอน"],
    "ราษฎร์บูรณะ": ["ราษฎร์บูรณะ", "ทุ่งครุ"],
    "สาธร":        ["สาทร"]                       // ตัวบทปี 2539 สะกด "สาธร"
  } }]
};
const AMP_ALIAS = {};
